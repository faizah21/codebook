...
// Whenever dark ode is changed we will call this useEffect, if darkmode is true then we will add and if not then we remove it. Have to store in local storage so that on second or third reload, etc., the dark mode is still there
export const Header = () => {
